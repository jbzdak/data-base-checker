...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AutogradingResult.partial_grade'
        db.add_column(u'grading_autogradingresult', 'partial_grade',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='autogrades', null=True, to=orm['grading.PartialGrade']),
                      keep_default=False)


    def backwards(self, orm):

        # Deleting field 'AutogradingResult.partial_grade'
        db.delete_column(u'grading_autogradingresult', 'partial_grade_id')
