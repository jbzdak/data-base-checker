...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentGrade.grade'
        db.add_column(u'grading_studentgrade', 'grade',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudentGrade.grade'
        db.delete_column(u'grading_studentgrade', 'grade')
