...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.slug_field'
        db.alter_column('grading_course', 'slug_field', self.gf('django.db.models.fields.SlugField')(unique=True, null=True, max_length=100))

        # Changing field 'GradeableActivity.slug_field'
        db.alter_column('grading_gradeableactivity', 'slug_field', self.gf('django.db.models.fields.SlugField')(unique=True, null=True, max_length=100))

        # Changing field 'GradePart.slug_field'
        db.alter_column('grading_gradepart', 'slug_field', self.gf('django.db.models.fields.SlugField')(unique=True, null=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'Course.slug_field'
        db.alter_column('grading_course', 'slug_field', self.gf('django.db.models.fields.SlugField')(unique=True, null=True, max_length=50))

        # Changing field 'GradeableActivity.slug_field'
        db.alter_column('grading_gradeableactivity', 'slug_field', self.gf('django.db.models.fields.SlugField')(unique=True, null=True, max_length=50))

        # Changing field 'GradePart.slug_field'
        db.alter_column('grading_gradepart', 'slug_field', self.gf('django.db.models.fields.SlugField')(unique=True, null=True, max_length=50))
