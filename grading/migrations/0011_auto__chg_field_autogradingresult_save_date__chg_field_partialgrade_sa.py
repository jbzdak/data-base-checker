...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AutogradingResult.save_date'
        db.alter_column('grading_autogradingresult', 'save_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'PartialGrade.save_date'
        db.alter_column('grading_partialgrade', 'save_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

    def backwards(self, orm):

        # Changing field 'AutogradingResult.save_date'
        db.alter_column('grading_autogradingresult', 'save_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 27, 0, 0)))

        # Changing field 'PartialGrade.save_date'
        db.alter_column('grading_partialgrade', 'save_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 27, 0, 0)))
    ...
    models = {
        ...
        'grading.autogradingresult': {
            ...
            'partial_grade': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'autogrades'", 'blank': 'True', 'null': 'True', 'to': "orm['grading.PartialGrade']"}),
        ...
        'grading.course': {
            ...
            'slug_field': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'blank': 'True', 'null': 'True', 'max_length': '50'}),
        ...
        'grading.gradeableactivity': {
            ...
            'default_grade': ('django.db.models.fields.DecimalField', [], {'decimal_places': '2', 'max_digits': '5', 'default': '2.0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'slug_field': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'blank': 'True', 'null': 'True', 'max_length': '50'}),
            'sort_key': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100'})
        ...
        'grading.gradepart': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'passing_grade': ('django.db.models.fields.DecimalField', [], {'decimal_places': '2', 'max_digits': '5', 'default': '3.0'}),
            'required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'slug_field': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'blank': 'True', 'null': 'True', 'max_length': '50'}),
            'sort_key': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100'}),
            'weight': ('django.db.models.fields.DecimalField', [], {'blank': 'True', 'decimal_places': '2', 'max_digits': '5', 'default': '1'})
        },
