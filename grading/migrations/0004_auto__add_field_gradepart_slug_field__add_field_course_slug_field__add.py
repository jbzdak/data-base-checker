...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AutogradingResult.save_date'
        db.add_column(u'grading_autogradingresult', 'save_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'GradePart.slug_field'
        db.add_column(u'grading_gradepart', 'slug_field',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PartialGrade.save_date'
        db.add_column(u'grading_partialgrade', 'save_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Course.slug_field'
        db.add_column(u'grading_course', 'slug_field',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GradeableActivity.slug_field'
        db.add_column(u'grading_gradeableactivity', 'slug_field',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AutogradingResult.save_date'
        db.delete_column(u'grading_autogradingresult', 'save_date')

        # Deleting field 'GradePart.slug_field'
        db.delete_column(u'grading_gradepart', 'slug_field')

        # Deleting field 'PartialGrade.save_date'
        db.delete_column(u'grading_partialgrade', 'save_date')

        # Deleting field 'Course.slug_field'
        db.delete_column(u'grading_course', 'slug_field')

        # Deleting field 'GradeableActivity.slug_field'
        db.delete_column(u'grading_gradeableactivity', 'slug_field')
    ...
    models = {
        ...
        'grading.autogradeablegradepart': {
            ...
            'parent': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'autograde'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['grading.GradePart']"})
        },
        'grading.autogradingresult': {
            'Meta': {'ordering': "['save_date']", 'unique_together': "(('student', 'grade_part'),)", 'object_name': 'AutogradingResult'},
            ...
            'partial_grade': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'autogrades'", 'null': 'True', 'to': "orm['grading.PartialGrade']"}),
        ...
        'grading.course': {
            ...
            'slug_field': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
